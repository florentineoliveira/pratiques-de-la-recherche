...
# <span style="color:#FAFAFA;">1. Reminder: Canonical 2x2 case</span>
...
- <span style="color:#9933FF"> Formally,</span>  $\color{#9933FF}{\underbrace{\mathbb{E}[Y_{i2}(0) - Y_{i1}(0) | D_i = 1 ]}_{\text{Changement de } Y(0) \text{ pour les traités}}  =  \underbrace{ \mathbb{E}[Y_{i2}(0) - Y_{i1}(0) | D_i = 0]}_{\text{Changement de } Y(0) \text{ pour les contrôles}}}$ 
...
# <span style="color:#FAFAFA;">2. Two-Way Fixed Effects</span>



---
# TWFE equivalence with DiD Estimator
...
$$Y_{it} = \beta \left(\mathbb{1}\{t = 2\} * D_{it} \right) + \alpha_i + \phi_t + \varepsilon_{it}$$
...
# <span style="color:#FAFAFA;">3. Staggered Treatment</span>



---
# Generalized model with staggered treatment
...
---
# Issue with TWFE in staggered treatment setting
...
# <span style="color:#FAFAFA;">4. Recent Estimators</span>
