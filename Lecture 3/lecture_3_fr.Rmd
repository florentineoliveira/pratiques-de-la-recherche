...
<span style="color:#9933FF"> $\color{#9933FF}{H_2}$ **Exogeneité**</span>: $X$ est exogène
...
<span style="color:#9933FF"> $\color{#9933FF}{H_4}$ **Homoscédasticité** </span>: $\varepsilon_i$ est _iid_ et de distribution $\mathcal{N}(0, \sigma^2)$
...
5) Calculer les estimateurs de $\beta_0$ et $\beta_1$ du modèle $\text{Nb Années études} = \beta_0 + \beta_1 \text{Taille Fratrie} + \varepsilon$, à la main et directement via la fonction `lm`
...
**Exemple canonique de l'équation de Mincer**: on cherche à estimer l'effet d'une année de scolarisation supplémentaire sur le salaire
  - problème: l'abilité, la motivation, ne sont pas observées
  - dans ce cas, le paramètre n'estime pas l'effet causal de l'éducation sur le salaire
