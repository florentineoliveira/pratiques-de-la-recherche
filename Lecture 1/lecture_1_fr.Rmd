...
3. Séance 3 (19/12/2024): Statistiques Descriptives
...
.center[
```{r datasets joints , echo=FALSE, out.width="50%"}
...
.left-column[
```{r datasets joints bindrows, echo=FALSE, out.width="150%"}
...
.left-column[
```{r datasets joints bindcols , echo=FALSE, out.width="150%"}
...
.left-column[
```{r joints left, echo=FALSE, out.width="200%"}
...
.left-column[
```{r joints right, echo=FALSE, out.width="200%"}
...
.left-column[
```{r joints inner, echo=FALSE, out.width="200%"}
...
.left-column[
```{r joints full, echo=FALSE, out.width="200%"}
...
.center[
```{r longer, echo=FALSE, out.width="50%"}
...
.center[
```{r wider, echo=FALSE, out.width="60%"}
