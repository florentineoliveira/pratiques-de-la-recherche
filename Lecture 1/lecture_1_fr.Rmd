...
#  "file:///Users/florentineoliveira/Desktop/Teaching/CPES/pratiques-de-la-recherche/Lecture 1/lecture_1_fr.html" \
#  "/Users/florentineoliveira/Desktop/Teaching/CPES/pratiques-de-la-recherche/Lecture 1/lecture_1_fr.pdf"
...
### Semestre 2
4. Séance 4 (TBC - 03/02/2026): Variables de Contrôle et Matching
5. Séance 5 (TBC - 17/02/2026): Méthode des Variables Instrumentales
6. Séance 6 (TBC - 03/03/2026): Méthode des Doubles-Différences (DiD)
7. Séance 7 (TBC - 17/03/2026): Regression Discontinuity Design (RDD)
8. Séance 8 (TBC - 31/03/2026): Q & A
...
<span style="color:#dd0747;">**1. La recherche en économie empirique**</span>

<span style="color:#dd0747;">**2. `R`: Rappels**</span>
...
# <span style="color:#FAFAFA;">1. La recherche en économie empirique</span>
...
# <span style="color:#FAFAFA;">2. `R`: rappels</span>
...
# <span style="color:#dd0747;">2.1. Définition, usage, interface</span>
...
.pull-left[
```{r popularity scholar, echo=FALSE, out.width="95%"}
knitr::include_graphics("imgs/popularity_datascientist.jpg")
```
]

.pull-right[
```{r popularity data, echo=FALSE, out.width="85%"}
...
# <span style="color:#dd0747;">2.2. Projet `R`</span>
...
.pull-left[
```{r rproj, echo=FALSE, out.width="70%"}
...
.pull-left[
```{r application rproj , echo=FALSE, out.width="80%"}
knitr::include_graphics("imgs/rproj_app.png")
```
]
...
# <span style="color:#dd0747;">2.3. Importer des données</span>
...
# <span style="color:#dd0747;">2.4. Manipulation des données avec `dplyr`</span>
...
# <span style="color:#dd0747;">2.5. Visualisation des données avec `ggplot2`</span>
...
# <span style="color:#dd0747;">2.6. Visualisation des données spaciales</span>
...
# <span style="color:#FAFAFA;">Miscellaneous</span>
...
# <span style="color:#FAFAFA;">Appendix</span>
